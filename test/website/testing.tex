...
\hypersetup{
  pdftitle={Testing cross-reference with holoviews charts},
...
\title{Testing cross-reference with holoviews charts}
...
See Figure~\ref{fig-plot} and Figure~\ref{fig-pairplot}
